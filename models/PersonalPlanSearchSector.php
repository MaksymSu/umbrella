 ...
 */
class PersonalPlanSearchSector extends PersonalPlan
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['content', 'started_at', 'finished_at', 'created_at', 'desc', 'theme_content','theme_num','started_at_fact','finished_at_fact'], 'safe'],
            [['labor'], 'double'],
        ];
    }
